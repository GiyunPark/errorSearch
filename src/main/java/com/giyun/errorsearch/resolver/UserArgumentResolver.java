package com.giyun.errorsearch.resolver;

import com.giyun.errorsearch.annotation.SocialUser;
...
import static com.giyun.errorsearch.domain.enums.SocialType.*;
    ...
    private void setRoleIfNotSame(User user, OAuth2Authentication authentication,
        ...
        if(!authentication.getAuthorities().contains(
            ...
            SecurityContextHolder.getContext().setAuthentication(
                    new UsernamePasswordAuthenticationToken(map, "N/A", AuthorityUtils
                            .createAuthorityList(user.getSocialType().getRoleType())));
        }
    }
}
